...
fig_pie = go.Figure(data=[go.Pie(labels=list(tickers.keys()), values=pesos_recomendados, hole=.4)])
    fig_pie.update_layout(height=400, showlegend=False, margin=dict(t=0, b=0, l=0, r=0))
